...
{
    switch (type) {
    case Molecule_Type::H: {
        os << "H";
        break;
    }
    case Molecule_Type::O: {
        os << "O";
        break;
    }

    case Molecule_Type::NO_TYPE: {
        os << "H";
        break;
    }
    default: {
        throw std::runtime_error("Unexpected molecule type value: " + std::to_string(static_cast<int>(type)));
    }
    }
    return os;
}
